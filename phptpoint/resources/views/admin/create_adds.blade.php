    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="col-md-12">
				...
				@endif
            <form class="form form-horizontal" id="submitForm" method="post" action="{{ route('adds.store') }}">
            	@csrf
            	
            	
                <div class="form-group">
                    <label>Add Title*</label>
                    <input type="text" class="form-control" name="add_name" id="add_name" value="{{ old('add_name') }}" placeholder="Enter Add Name" required>
                </div>
                <div class="form-group">
                    <label>Type</label>
                ...
                <div class="test_field">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="content"  rows="6" id="editor1" required>{{ old('content') }}</textarea>
                    </div>
