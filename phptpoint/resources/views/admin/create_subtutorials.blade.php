...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Add Sub-Tutorial</h3>
        ...
        <div class="box-body">
            <div class="col-md-12">
				...
				@endif
            <form class="form form-horizontal" id="submitForm" method="post" action="{{ route('subtutorials.store') }}">
            	@csrf
            	...
            	<div class="form-group">
            		...
            		<input type="text" class="form-control" name="sub_tutorial_name" id="tutorial_name" value="{{ old('sub_tutorial_name') }}" placeholder="Enter Sub-Tutorial Name to be displayed on menu bar" required>
            	</div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea lass="form-control" name="content" id="editor1" required>{{ old('content') }}</textarea>
                </div>
